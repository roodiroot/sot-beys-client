...
function CartMomentum() {
  ...
  const blur = useRef();
  const { minBasketActive, totalSumm, basket } = useSelector(
    (state) => state.basket
  );
  ...
  return (
    ...
    >
      ...
      <div className='cartMomentum__content'>
        <div
          onClick={(e) => dispatch(slipMinCart())}
          className='cartMomentum__header'
        >
        ...
        <div className='cartMomentum__body'>
          ...
          <div className='cartMomentum__sumBlock'>
            ...
            <div className='cartMomentum__totalCount'>
              {thousandPrice(totalSumm)}
            </div>
          </div>
        </div>
        <div className='cartMomentum__footer'>
          <button
            onClick={goToCart}
            className='cartMomentum__buttonCvadro buttonCvadro'
          >
            Перейти в корзину
          </button>
        </div>
