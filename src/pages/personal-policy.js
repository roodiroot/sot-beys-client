  ...
  return (
    <div className='policy'>
      <div className='policy__container'>
        <h3>Политика по использованию персональных данных</h3>
        <p>
          ...
          может получить о посетителях веб-сайта https://sot-bays.su. 2.
          ...
          https://sot-bays.su. 2.4. Информационная система персональных данных —
          ...
          определяемому Пользователю веб-сайта https://sot-bays.su. 2.9.
          ...
          посетитель веб-сайта https://sot-bays.su. 2.11. Предоставление
          ...
          Политики в отношении обработки персональных данных. 6.1. Обработка
          ...
          обработки персональных данных Пользователя: — информирование
          Пользователя посредством отправки электронных писем. 7.2. Также
          ...
          info@sot-bays.su с пометкой «Отказ от уведомлений о новых продуктах и
          ...
          специальные формы, расположенные на сайте https://www.sot-bays.su или
          ...
          электронной почты Оператора info@sot-bays.su с пометкой «Актуализация
          ...
          Оператора info@sot-bays.su с пометкой «Отзыв согласия на обработку
          ...
          почты info@sot-bays.su 14.2. В данном документе будут отражены любые
          ...
          адресу https://www.sot-bays.su/personal-policy.
        </p>
      </div>
    </div>
  );
